    ...
    return (
        <section id='about' className='section_container'>
            ...
            <div className='container about_container'>
                <p>Arman Kabir is an enthusiastic and skilled web developer with a deep passion for crafting outstanding web applications. He is a computer science and engineering graduate and participated 1 year long professional web development bootcamp in which he scored top 5%
                ...
                <p>In the front-end , my proficiency includes HTML, CSS, javaScript, TypeScript, ReactJs, NextJs and Redux. I'm well versed in component-driven development and i enjoy working with UI
